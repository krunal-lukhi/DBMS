...
from CRUD_UNESCO.forms import SiteForms
from CRUD_UNESCO.models import InstModel
from CRUD_UNESCO.forms import InstForms
from CRUD_UNESCO.models import CountryModel
from CRUD_UNESCO.forms import CountryForms

def homepage(request):
    return render(request, 'index.html')

def search_site(request):
    q = request.POST.getlist('scategory')
    if 'Natural' in q:
